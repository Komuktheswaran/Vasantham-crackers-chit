...
const Reports = () => {
    ...
    return (
        <div className="page-container">
            <Title level={2} className="page-title mb-24">Reports & Analytics</Title>
                    ...
                    >
                        <ResponsiveContainer width="100%" height={400}>
                            <BarChart data={monthlyData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                                ...
                                <Bar dataKey="payments" fill="var(--secondary-color)" name="Payments Received" radius={[4, 4, 0, 0]} />
                                <Bar dataKey="due" fill="var(--warning-color)" name="Pending Dues" radius={[4, 4, 0, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </Card>
                </Col>
                        ...
                        <Row gutter={[16, 24]}>
                            <Col span={12}>
                                <div style={{ textAlign: 'center' }}>
                                    <Typography.Text type="secondary">Total Schemes</Typography.Text>
                                    <Title level={3} style={{ margin: '8px 0', color: 'var(--primary-color)' }}>
                            ...
                            <Col span={12}>
                                <div style={{ textAlign: 'center' }}>
                                    ...
                                    <Title level={3} style={{ margin: '8px 0', color: 'var(--secondary-color)' }}>
                            ...
                            <Col span={24}>
                                <div style={{ textAlign: 'center', marginTop: 16 }}>
                                    <Typography.Text type="secondary">Total Estimated Revenue</Typography.Text>
                                    <Title level={3} style={{ margin: '8px 0', color: 'var(--text-main)' }}>
